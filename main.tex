...
To ensure structural integrity, we implemented Transformer-to-Mamba Feature Distillation (T2MD). Drawing on principles from the DiMSUM \cite{phung2024dimsum} and StateSpaceDiffuser \cite{statespacediffuser2025} frameworks, we utilized a pre-trained, frozen multi-head self-attention DiT as a ``Teacher'' network. 
